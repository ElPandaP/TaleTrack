        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltTitle = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Length = table.Column<int>(type: "integer", nullable: false),
                    PosterUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    ...
                    SeasonEpisodeCounts = table.Column<int[]>(type: "integer[]", nullable: true),
                    FirstTrackedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareBookProgress = table.Column<bool>(type: "boolean", nullable: false),
                    ShareBookReviews = table.Column<bool>(type: "boolean", nullable: false),
                    ShareMovieProgress = table.Column<bool>(type: "boolean", nullable: false),
                    ShareMovieReviews = table.Column<bool>(type: "boolean", nullable: false),
                    ShareSeriesProgress = table.Column<bool>(type: "boolean", nullable: false),
                    ShareSeriesReviews = table.Column<bool>(type: "boolean", nullable: false),
                    GoogleId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    EmailCode = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: true),
                    EmailCodeExpiry = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
